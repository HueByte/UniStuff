...
int main()
{
	...
	std::cout << matrix1.toString() << " + " << std::endl << matrix2.toString() << std::endl;
	std::cout << "Result:" << std::endl << additionResult.toString();

	std::cout << "\n---------\n\n";

	Matrix<double> subtractionResult = matrix1.subtract(matrix2);
	std::cout << matrix1.toString() << " - " << std::endl << matrix2.toString() << std::endl;
	std::cout << "Result:" << std::endl << subtractionResult.toString();

	std::cout << "\n---------\n\n";

	Matrix<double> multiplicationResult = matrix1.multiply(matrix2);
	std::cout << matrix1.toString() << " * " << std::endl << matrix2.toString() << std::endl;
	std::cout << "Result:" << std::endl << multiplicationResult.toString();

	std::cout << "\n---------\n\n";

	Matrix<double> overloadAddResult = matrix1 + 1;
	std::cout << matrix1.toString() << " + " << std::endl << "1" << std::endl;
